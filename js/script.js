...
let cart = JSON.parse(localStorage.getItem("pakakCart")) || [];
...
function addToCart(name, price) {
    ...
    localStorage.setItem("pakakCart", JSON.stringify(cart));
...
function checkout() {
    ...
    const orders = JSON.parse(localStorage.getItem("pakakOrders")) || [];
    ...
    orders.push(order);
    localStorage.setItem("pakakOrders", JSON.stringify(orders));

    alert("Thank you for shopping with PAKAK!\n\nCheckout Successful.\nOrder ID: " + order.id);
...
window.addEventListener("load", () => {
    if (!sessionStorage.getItem("welcomeShown")) {
        alert("Welcome to PAKAK Tech Store!");
